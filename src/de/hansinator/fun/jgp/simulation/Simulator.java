...
public class Simulator {
    ...
    private void run(MainView mainView, InfoPanel infoPanel)
    {
    	...
    	System.out.println("Start time: " + DateTimeFormat.fullDateTime().withZone(DateTimeZone.getDefault()).print(startTime));
        ...
        synchronized(runLock)
        {
	        while (running) {
	            ...
	            if ((now - lastStatsTime) >= 3000) {
	                long evaluationsPerMinute = (evaluationCount - lastEvaluationCount) * (60000 / (now - lastStatsTime));
        ...
        System.out.println("Average GPM: " + ((evaluationsPerMinuteCount > 0) ? (evaluationsPerMinuteAverage / evaluationsPerMinuteCount) : 0));
    }
