...
public class EvoCompiler
{
	...
	public static LGPMachine compile(final int numRegs, int numInputRegs, OpCode[] program) throws IOException
	{
		...
		final int[] lops = new int[LGPMachine.ops.length];
		mg.loadThis();
		...
		for (int i = 0; i < LGPMachine.ops.length; i++)
		{
